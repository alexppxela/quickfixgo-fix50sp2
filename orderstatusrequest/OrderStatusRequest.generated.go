...
func (m OrderStatusRequest) SetCurrency(v string) {
...
func (m OrderStatusRequest) GetCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m OrderStatusRequest) HasCurrency() bool {
