...
func (m OrderMassCancelRequest) SetCurrency(v string) {
...
func (m OrderMassCancelRequest) GetCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m OrderMassCancelRequest) HasCurrency() bool {
